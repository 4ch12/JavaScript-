...
// Задание #2
// Напишите функцию getDateDifference(), 
// которая возвращает разницу в днях между двумя датами.
...
// Задание #3
// Напишите функцию getTimeUntilDate(date), которая 
// возвращает объект с информацией о том, сколько
//  времени осталось от текущей даты до переданной. 
